...
class Right_L_Block(Block):
    ...
    def __init__(self, settings, screen):
        ...
        self.image = pg.image.load('images/right_L_piece.png')
    ...
    def rotate_right(self):
        if self.permutation == 0:
            ...
            self.pieces[0].rect.bottom = self.pieces[1].rect.bottom
    ...
    def rotate_left(self):
        if self.permutation == 0:
            self.pieces[0].rect.top = self.pieces[3].rect.top
            self.pieces[1].rect.topleft = self.pieces[2].rect.topright
            self.pieces[3].rect.topright = self.pieces[2].rect.topleft
            ...
            self.pieces[0].rect.left = self.pieces[3].rect.left
            self.pieces[1].rect.topleft = self.pieces[0].rect.topright
            self.pieces[3].rect.topleft = self.pieces[2].rect.bottomleft