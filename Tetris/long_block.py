...
class Long_Block(Block):
    ...
    def __init__(self, settings, screen):
        ...
        self.image = pg.image.load('images/long_piece.png')
        ...
        self.piece1_rect.left, self.piece1_rect.top = settings.screen_width / 2 - settings.block_size * 2, settings.block_size
    ...
    def rotate_right(self):
        if self.permutation == 0:
            ...
            self.pieces[2].rect.topleft = self.pieces[1].rect.topright
            self.pieces[3].rect.topleft = self.pieces[2].rect.topright

        elif self.permutation == 1:
            self.pieces[3].rect.bottomleft = self.pieces[2].rect.topleft
            self.pieces[1].rect.topleft = self.pieces[2].rect.bottomleft
            self.pieces[0].rect.topleft = self.pieces[1].rect.bottomleft

        elif self.permutation == 2:
            self.pieces[0].rect.topleft = self.pieces[1].rect.topright
            self.pieces[2].rect.topright = self.pieces[1].rect.topleft
            self.pieces[3].rect.topright = self.pieces[2].rect.topleft

        elif self.permutation == 3:
            self.pieces[3].rect.topleft = self.pieces[2].rect.bottomleft
    ...
    def rotate_left(self):
        if self.permutation == 0:
            ...
            self.pieces[0].rect.topleft = self.pieces[1].rect.bottomleft
            self.pieces[2].rect.bottomleft = self.pieces[1].rect.topleft
            self.pieces[3].rect.bottomleft = self.pieces[2].rect.topleft

        elif self.permutation == 2:
            self.pieces[3].rect.topright = self.pieces[2].rect.topleft
            self.pieces[1].rect.topleft = self.pieces[2].rect.topright
            self.pieces[0].rect.topleft = self.pieces[1].rect.topright
