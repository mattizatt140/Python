...
graph.addEdge(Edge(graph.getNode(1), graph.getNode(2)))
graph.addEdge(Edge(graph.getNode(2), graph.getNode(3)))
graph.addEdge(Edge(graph.getNode(3), graph.getNode(4)))
graph.addEdge(Edge(graph.getNode(4), graph.getNode(5)))
graph.addEdge(Edge(graph.getNode(1), graph.getNode(5)))
print(graph.BFS(graph.getNode(1), graph.getNode(5)))