...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        height: an integer > 0
        """
        self.room = [[False for x in range(height)] for y in range(width)]
        self.width = width
        self.height = height
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        tempNewX = self.position.getNewPosition(self.dir, self.speed).getX()
        tempNewY = self.position.getNewPosition(self.dir, self.speed).getY()
        if tempNewX < self.room.width and tempNewY < self.room.height and tempNewX > 0 and tempNewY > 0:
    ...
    for i in range(num_trials):
        ...
        while not isMin:
            ...
            for i in range(num_robots):
                ...
                if (recRoom.getNumCleanedTiles() / recRoom.getNumTiles()) >= min_coverage:
                    isMin = True
                    break
        anim.done()
...
print(runSimulation(3, 1.0, 10, 10, 1.00, 1000, RandomWalkRobot))