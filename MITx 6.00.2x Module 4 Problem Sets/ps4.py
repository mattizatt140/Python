...
INTERVAL_1 = list(range(1961, 2006))v
...
def generate_models(x, y, degs):
    ...
    # Generate models of all degrees
    for i in range(len(degs)):
        LoA.append(np.array(np.polyfit(x, y, degs[i])))
...
def r_squared(y, estimated):
    ...
    """
    # Turns lists into arrays for data structure functions
    y = np.array(y); estimated = np.array(estimated)
    ...
    # Return the mean error divided by the data's variance
